...
class VistaDipendente(QWidget):
    def __init__(self, dipendente, controllore, callback):
        ...
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Nome: {}</span></p></body></html>".format(
                self.controller.get_nome_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Cognome: {}</span></p></body></html>".format(
                self.controller.get_cognome_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Codice Fiscale: {}</span></p></body></html>".format(
                self.controller.get_cf_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Data Nascita: {}</span></p></body></html>".format(
                self.controller.get_data_nascita_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Luogo Nascita: {}</span></p></body></html>".format(
                self.controller.get_luogo_nascita_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Telefono: {}</span></p></body></html>".format(
                self.controller.get_telefono_dipendente())))
        self.verticalLayout.addWidget(self.get_info(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-style:italic;\">Ruolo: {}</span></p></body></html>".format(
                self.controller.get_ruolo_dipendente())))
    ...
    def retranslateUi(self):  # Funzione che connette il pulsante alla rispettiva funzione, e che passa al label d'intestazione il nome e cognome del dipendente
        ...
        self.label_name.setText(QCoreApplication.translate("Form",
                                                           self.controller.get_nome_dipendente() + " " + self.controller.get_cognome_dipendente()))
